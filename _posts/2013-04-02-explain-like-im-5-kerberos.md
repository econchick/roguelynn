...
<img class="displayed" src="{{ get_asset('images/Kerb.001.jpg')}}" width="630" height="475" alt="Kerberos Realm"/>
...
<img class="displayed" src="{{ get_asset('images/Kerb.003.jpg')}}" width="630" height="475" alt="AS DB check"/>
